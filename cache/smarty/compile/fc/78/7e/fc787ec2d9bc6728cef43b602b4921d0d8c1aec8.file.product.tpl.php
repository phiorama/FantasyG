<?php /* Smarty version Smarty-3.1.19, created on 2016-08-31 11:09:21
         compiled from "/var/www/public/Manni/themes/pos_karan1/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:37270561457c6f321c09c20-35402872%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc787ec2d9bc6728cef43b602b4921d0d8c1aec8' => 
    array (
      0 => '/var/www/public/Manni/themes/pos_karan1/product.tpl',
      1 => 1472653909,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '37270561457c6f321c09c20-35402872',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c6f322654c01_47392138',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c6f322654c01_47392138')) {function content_57c6f322654c01_47392138($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/public/Manni/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/public/Manni/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/public/Manni/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/var/www/public/Manni/tools/smarty/plugins/function.counter.php';
					...
					<div class="box-cart-bottom">
						<p id="add_to_cart" class="buttons_bottom_block no-print <?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||(isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&$_smarty_tpl->tpl_vars['restricted_country_mode']->value)||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> unvisible<?php }?>">
							<button type="submit" name="Submit" class="exclusive">
								<i class="icon2-basket"></i><span><?php if ($_smarty_tpl->tpl_vars['content_only']->value&&(isset($_smarty_tpl->tpl_vars['product']->value->customization_required)&&$_smarty_tpl->tpl_vars['product']->value->customization_required)) {?><?php echo smartyTranslate(array('s'=>'Customize'),$_smarty_tpl);?>
...
<?php }?>
	...
	<div class="product_tab_container">
		<ul class="nav nav-tabs clearfix">
			<?php if ((isset($_smarty_tpl->tpl_vars['quantity_discounts']->value)&&count($_smarty_tpl->tpl_vars['quantity_discounts']->value)>0)) {?><li><a data-toggle="tab" href="#tab1"><?php echo smartyTranslate(array('s'=>'Volume discounts'),$_smarty_tpl);?>
</a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?><li class="active"><a data-toggle="tab" href="#tab2"><?php echo smartyTranslate(array('s'=>'Data sheet'),$_smarty_tpl);?>
</a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?><li><a data-toggle="tab" href="#tab3"><?php echo smartyTranslate(array('s'=>'More info'),$_smarty_tpl);?>
</a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['packItems']->value)&&count($_smarty_tpl->tpl_vars['packItems']->value)>0) {?><li><a data-toggle="tab" href="#tab4"><?php echo smartyTranslate(array('s'=>'Pack content'),$_smarty_tpl);?>
</a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['attachments']->value)&&$_smarty_tpl->tpl_vars['attachments']->value) {?><li><a data-toggle="tab" href="#tab5"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->customizable) {?><li><a data-toggle="tab" href="#tab6"><?php echo smartyTranslate(array('s'=>'Product customization'),$_smarty_tpl);?>
</a></li><?php }?>
...
loader.gif" alt="loader" />
	...
	<div class="accessories_container product_block_container main_container">
		<div class="header_title">
			<h3 class="title_in"><?php echo smartyTranslate(array('s'=>'Accessories'),$_smarty_tpl);?>
</h3>
		</div>
		<div class="accessories-block product_content">
			<div class="navi">
				<a class="prevtab"><i class="icon-long-arrow-left"></i></a>
				<a class="nexttab"><i class="icon-long-arrow-right"></i></a>
			</div>
			<div class="row">
...
"/>
								...
								<div class="right-block" title="<?php echo strip_tags($_smarty_tpl->tpl_vars['accessory']->value['description_short']);?>
">
									<h5 itemprop="name">
...
">
									...
									<div class="price-box">
										...
										<span class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPrice'][0][0]->displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['accessory']->value['price']),$_smarty_tpl);?>
</span>
										<?php } else { ?>
										<span class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPrice'][0][0]->displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['accessory']->value['price_tax_exc']),$_smarty_tpl);?>
</span>
										<?php }?>
									</div>
									<?php }?>
									<div class="btn_container">
										<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)) {?>
											<a class="button ajax_add_to_cart_button exclusive" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
...
"
												class="quick-view"
												href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
">
