...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57c6f35d317f42_30034352',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c6f35d317f42_30034352')) {function content_57c6f35d317f42_30034352($_smarty_tpl) {?><div class="socialsharing_product list-inline no-print"> <span class="share_label titleFont">Share</span> <button data-type="twitter" type="button" class="btn btn-default btn-twitter social-sharing"> <i class="icon-twitter"></i> Tweet </button> <button data-type="facebook" type="button" class="btn btn-default btn-facebook social-sharing"> <i class="icon-facebook"></i> Share </button> <button data-type="google-plus" type="button" class="btn btn-default btn-google-plus social-sharing"> <i class="icon-google-plus"></i> Google+ </button> <button data-type="pinterest" type="button" class="btn btn-default btn-pinterest social-sharing"> <i class="icon-pinterest"></i> Pinterest </button></div><?php }} ?>
