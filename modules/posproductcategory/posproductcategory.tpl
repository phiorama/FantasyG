<div class="index_container posproductcategory">
<div class="container">
<div class="row row_edit">
	{foreach from=$productCates item=productCate name=posproductcategory}
		<div class="col-xs-12 col-sm-4">
			<div class="side_container side_{$productCate.id}">
				<div class="header_title">
					<h3 class="fontcustom2">{$productCate.name}</h3>
					<div class="navi navi_{$productCate.id} hidden">
										...
										<div class="right-block">
											...
											<div class="btn_in">
												...
												{if isset($comparator_max_item) && $comparator_max_item}
													<a class="add_to_compare" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='Add to Compare' mod='posproductcategory'}" data-id-product="{$product.id_product}">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				var posproductcategory = $(".tab_{$productCate.id}");
				posproductcategory.owlCarousel({
					singleItem: true,
					addClassActive: true,
				});
				$(".side_{$productCate.id} .nexttab").click(function(){
					posproductcategory.trigger('owl.next');})
				$(".side_{$productCate.id} .prevtab").click(function(){
