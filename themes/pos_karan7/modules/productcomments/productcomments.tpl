						...
						{foreach from=$criterions item='criterion'}
							<li>
								...
								<div class="star_content">
									<input type="radio" name="criterion[{$criterion.id_product_comment_criterion|round}]" value="1" />
									<input type="radio" name="criterion[{$criterion.id_product_comment_criterion|round}]" value="2" />
									<input type="radio" name="criterion[{$criterion.id_product_comment_criterion|round}]" value="3" />
									<input type="radio" name="criterion[{$criterion.id_product_comment_criterion|round}]" value="4" checked="checked" />
									<input type="radio" name="criterion[{$criterion.id_product_comment_criterion|round}]" value="5" />
								</div>
