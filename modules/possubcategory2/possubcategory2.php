<?php
class possubcategory2 extends Module {
	private $spacer_size = '5';	
	private $_postErrors  = array();
	private $_html= null;
	public $cate_imgname;
	public function __construct() {
		$this->name 		= 'possubcategory2';
		$this->tab 			= 'front_office_features';
		$this->version 		= '1.5';
		$this->author 		= 'posthemes';
		$this->displayName 	= $this->l('Category Sub Slider 2');
		$this->description 	= $this->l('Category Sub Slider 2');
		parent :: __construct();
	}
	...
	Configuration::updateGlobalValue($this->name . '_list_cate',$cateDefault);
      ...
      public function uninstall() {
        ...
        $this->_clearCache('possubcategory2.tpl');
	...
	{
		$this->context->controller->addCSS(($this->_path).'possubcategory2.css', 'all');
	}
	public function hookblockPosition1($params) {
		...
		return $this->display(__FILE__, 'possubcategory2.tpl');
	}
