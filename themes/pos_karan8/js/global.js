...
$(document).ready(function(){
	...
	$(".megamenu_container .btn_tgl").on('click', function(e){
		...
		if(subUl.is(':hidden'))
		{
			subUl.fadeIn().addClass("active");
			$(".megamenu_container .btn_tgl").addClass("active");
			$(".banner_fix_in").addClass("active");
		}
		else
		{
			subUl.fadeOut().removeClass("active");
			$(".megamenu_container .btn_tgl").removeClass("active");
			$(".banner_fix_in").removeClass("active");
		}
		$("content_tgl").fadeOut().removeClass("active");
		e.preventDefault();
	});
	...
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container item"><div class="row">';
				...
				html += '<div class="col-xs-12 col-sm-7 col-md-8"><div class="right-block">' + $(element).find('.right-block').html() + '</div></div>';
			html += '</div></div>';
			$(element).html(html);
		});
