	...
	{if !isset($content_only) || !$content_only}
		...
		<div id="page">
			<div class="header-container">
				<header id="header" class="box_content">
					...
					{/if}
						...
						<div class="blockright">
							<div class="megamenu_container hidden-xs">
								<a class="icon_top btn_tgl" href="javascript:void(0)" title="{l s='Category'}">
									<i class="icon2-menu"></i>
								</a>
							</div>
			...
			{hook h="blockposition5"}
				...
				<div class="banner_fix">
					...
					{if $page_name == 'index'}
					<div class="box_content banner_fix_in">
