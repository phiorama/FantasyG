	...
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container item"><div class="row">';
				html += '<div class="col-xs-4 col-sm-5 col-md-4"><div class="left-block">' + $(element).find('.left-block').html() + '</div></div>';
				html += '<div class="col-xs-4 col-sm-7 col-md-8"><div class="right-block">' + $(element).find('.right-block').html() + '</div></div>';
			html += '</div></div>';
			$(element).html(html);
		});
