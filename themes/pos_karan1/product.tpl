...
<div itemscope itemtype="https://schema.org/Product">
					...
					<div id="thumbs_list">
						...
						{if isset($images)}
							{foreach from=$images item=image name=thumbnails}
								...
								{/if}
								<div class="item">
								<div id="thumbnail_{$image.id_image}"{if $smarty.foreach.thumbnails.last} class="last"{/if}>
					...
					<div class="box-cart-bottom">
						<p id="add_to_cart" class="buttons_bottom_block no-print {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} unvisible{/if}">
							<button type="submit" name="Submit" class="exclusive">
								<i class="icon2-basket"></i><span>{if $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}{else}{l s='Add to cart'}{/if}</span>
							</button>
						</p>
	...
	<div class="product_tab_container">
		<ul class="nav nav-tabs clearfix">
			{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}<li><a data-toggle="tab" href="#tab1">{l s='Volume discounts'}</a></li>{/if}
			{if isset($features) && $features}<li class="active"><a data-toggle="tab" href="#tab2">{l s='Data sheet'}</a></li>{/if}
			{if isset($product) && $product->description}<li><a data-toggle="tab" href="#tab3">{l s='More info'}</a></li>{/if}
			{if isset($packItems) && $packItems|@count > 0}<li><a data-toggle="tab" href="#tab4">{l s='Pack content'}</a></li>{/if}
			{if isset($attachments) && $attachments}<li><a data-toggle="tab" href="#tab5">{l s='Download'}</a></li>{/if}
			{if isset($product) && $product->customizable}<li><a data-toggle="tab" href="#tab6">{l s='Product customization'}</a></li>{/if}
			{$HOOK_PRODUCT_TAB}
		</ul>
	...
	<div class="accessories_container product_block_container main_container">
		<div class="header_title">
			<h3 class="title_in">{l s='Accessories'}</h3>
		</div>
					...
					{/if}
						{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
							...
							<div class="item">
								...
								<div class="right-block" title="{$accessory.description_short|strip_tags:false}">
									<h5 itemprop="name">
									...
									<div class="price-box">
										...
										{else}
										<span class="price">{displayWtPrice p=$accessory.price_tax_exc}</span>
										{/if}
									</div>
									{/if}
									<div class="btn_container">
										{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
											<a class="button ajax_add_to_cart_button exclusive" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart'}">
