<?php
class poscategorylist1 extends Module {
	private $spacer_size = '5';	
	private $_postErrors  = array();
	private $_html= null;
	public $cate_imgname;
	public function __construct() {
		$this->name 		= 'poscategorylist1';
		$this->tab 			= 'front_office_features';
		$this->version 		= '1.5';
		$this->author 		= 'posthemes';
		$this->displayName 	= $this->l('Category Main Slider 1');
		$this->description 	= $this->l('Category Main Slider 1');
		parent :: __construct();
	}
	...
	Configuration::updateGlobalValue($this->name . '_list_cate',$cateDefault);
      ...
      public function uninstall() {
        ...
        $this->_clearCache('poscategorylist1.tpl');
	...
	{
		$this->context->controller->addCSS(($this->_path).'poscategorylist1.css', 'all');
	}
	public function hookblockPosition1($params) {
		...
		return $this->display(__FILE__, 'poscategorylist1.tpl');
	}
